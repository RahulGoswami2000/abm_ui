  ...
  return (
    <Box sx={{ padding: 4, textAlign: 'center', backgroundColor: '#f5f5f5' }}>
      ...
      >
        ...
        <Typography variant="h6" sx={{ maxWidth: 600, mx: 'auto', fontWeight: 500 }}>
          Use this app to stay motivated, track progress, and achieve your goals in leaving habits behind for good.
        </Typography>
      </Box>
      ...
      <Typography variant="body1" sx={{ mb: 4, maxWidth: 700, mx: 'auto', lineHeight: 1.8, fontSize: '1.1rem' }}>
        {motivationalContent}
      </Typography>
      ...
      <Box sx={{ textAlign: 'center', marginBottom: 4 }}>
        ...
        <Typography variant="body2" paragraph>
          Below is a visual representation of your journey so far. Stay motivated and keep moving forward!
        </Typography>
      </Box>
