...
const ImageHoverTracker: React.FC = () => {
  ...
  const generateFeedback = async () => {
    const inputPrompt = `The user spent ${
      ...
      hoverTimeImage2 / 360
    } seconds on the neutral image. Provide feedback on engagement and how they can cure there anxiety if they are looking at negative aspect and make it just three line please.`;
